...
def filmStreams(filmName, filmYear, country):
    ...
    URL = "https://api.themoviedb.org/3/search/movie?api_key=2db4d39262edfacc167e5e29f7140967&language=en-AU&query=" + filmSearch + "&page=1&include_adult=false&year=" + str(filmYear)
...
# }
    ...
    URL = "https://api.themoviedb.org/3/movie/"+str(id)+"/watch/providers?api_key=2db4d39262edfacc167e5e29f7140967"
    page = requests.get(URL)
    a = json.loads(page.content.decode('utf-8'))
    streamList = []
    # if user == "Lily":
...
def streamImagesLinks(streamer, country):
    ...
    if country == "AU":
        URL = "https://api.themoviedb.org/3/watch/providers/movie?api_key=2db4d39262edfacc167e5e29f7140967&language=en-AU&watch_region=AU"
        page = requests.get(URL)
        ...
        URL = "https://api.themoviedb.org/3/watch/providers/movie?api_key=2db4d39262edfacc167e5e29f7140967&language=en-GB&watch_region=GB"
        page = requests.get(URL)
        ...
        URL = "https://api.themoviedb.org/3/watch/providers/movie?api_key=2db4d39262edfacc167e5e29f7140967&language=en-SA&watch_region=SA"
        page = requests.get(URL)
