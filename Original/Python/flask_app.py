...
# Setting up the session. Not massively sure what is happening here.
app = Flask(__name__, template_folder = 'templates')
app.config["SECRET_KEY"] = "kldfkjeurirbcxksdkjhdf"
...
def home():
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw01_user_homepage_not_logged_in.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        film_name=film_name,
...
def login():
        ...
        # If they click log in...
            ...
            if username.lower() in user_file.index:
                ...
                # If they got the password, lets them know and they go again.
                    ...
                    f = open('/home/lwalsh23/20241004_website_update/lw03_login_failed.txt', 'r')
                page = f.read()
                f.close()
                return page
    ...
    # The log in screen
    f = open('/home/lwalsh23/20241004_website_update/lw02_log_in.txt', 'r')
    page = f.read()
    f.close()
    return page
...
def createUser():
    ...
    if request.method == "POST":
        ...
        if request.form["action"] == "Create account":
            ...
            # lets them know.
            if accountDetails['User'].eq(request.form["user"]).any():
                f = open('/home/lwalsh23/20241004_website_update/lw07_sign_up_email_or_user_taken.txt', 'r')
                page = f.read()
                f.close()
                return page
            ...
            if not user or not password or not re.match(r'^[A-Za-z0-9]+$', user):
                f = open('/home/lwalsh23/20241004_website_update/lw08_sign_up_user_or_pass_blank.txt', 'r')
                page = f.read()
                f.close()
                return page
    ...
    # New user menu.
    f = open('/home/lwalsh23/20241004_website_update/lw06_sign_up.txt', 'r')
    page = f.read()
    f.close()
    return page
...
'''
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw04_user_homepage_logged_in.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
...
'''
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw10_search_results.txt', 'r')
    page = f.read()
    f.close()
...
'''
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw11_film_page.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        film_name=film_name,
...
def newRateMostVoted():
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw12_film_rating_page.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        film_tconst=film_tconst,
...
def newRateMostVotedNew():
    ...
    # What the user sees, ask them to submit a rating on a given film.
    f = open('/home/lwalsh23/20241004_website_update/lw13_new_film_rating_page.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        film_tconst=film_tconst,
...
def newFilmFilter():
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw14_feeling_picky.txt', 'r')
    page = f.read()
    f.close()
...
def newFilmFilterFinder():
    ...
    if session['recCount'] >= len(userProjRecList):
                f = open('/home/lwalsh23/20241004_website_update/lw18_feeling_picky_out_of_films.txt', 'r')
                page = f.read()
                f.close()
                return page.format(user=user)
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw17_feeling_picky_rec.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        user = user,
...
def newPartnerFind():
    ...
    f = open('/home/lwalsh23/20241004_website_update/lw15_feeling_friendly.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        user=user,
...
def newPartnerFilmFinder():
    ...
    # This is what they user sees, they are recommended a film and can say yes ot no.
    f = open('/home/lwalsh23/20241004_website_update/lw16_party_film_rec.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        user = user,
...
def feelingPretentious():
    ...
    # This is what they user sees, they are recommended a film and can say yes ot no.
    f = open('/home/lwalsh23/20241004_website_update/lw19_feeling_pretentious_rec.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        user = user,
...
def lboxUpload():
    ...
    # This is what they user sees, they are recommended a film and can say yes ot no.
    f = open('/home/lwalsh23/20241004_website_update/lw20_lbox_upload.txt', 'r')
    page = f.read()
    f.close()
    return page.format(
        user=user,
